...
########################### INTRO FUNCTIONS ####################################
    ...
    def start_draw(self):
        ...
        self.draw_text('PUSH SPACE BAR TO START', self.screen, [WIDTH // 2, HEIGHT // 2 + 50], START_TEXT_SIZE, WHITE,
                       START_FONT, True)
        self.draw_text('1 PLAYER ONLY', self.screen, [WIDTH // 2, HEIGHT // 2 + 100], START_TEXT_SIZE, MINT, START_FONT,
                       True)
        self.draw_text('© 2020 BICICLETE.RO', self.screen, [WIDTH // 2, HEIGHT // 2 + 150], START_TEXT_SIZE, BLUE,
                       START_FONT, True)
